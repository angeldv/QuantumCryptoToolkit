// src/main.js
/**
 * Main entry point for QuantumCryptoToolkit application
 */
...
class QuantumCryptoToolkit {
    /**
     * Create a new QuantumCryptoToolkit instance
...
module.exports = QuantumCryptoToolkit;
...
if (require.main === module) {
    ...
    const app = new QuantumCryptoToolkit({
        input: args.input,
        output: args.output,
